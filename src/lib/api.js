...
export const api = {
  ...
  getPendingVendors: () => request("/admin/pending-vendors"),
  approveVendorAccount: (id) => request(`/admin/pending-vendors/${id}/approve`, { method: "PUT" }),
  rejectVendorAccount: (id) => request(`/admin/pending-vendors/${id}/reject`, { method: "PUT" }),

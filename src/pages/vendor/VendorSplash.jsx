...
export default function VendorSplash() {
  ...
  return (
    <div className="min-h-[100dvh] bg-brand-bg flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 text-center">
        ...
        >
          <Store size={48} className="text-brand-orange" />
        </motion.div>
        ...
        >
          List your services, manage bookings, and grow your pet care business
        </motion.p>
      </div>
      ...
      >
        <button onClick={() => nav("/vendor/login")} className="btn-primary w-full">
          Sign In
        </button>
        <button onClick={() => nav("/vendor/signup")} className="btn-outline w-full">
          Create Account
        </button>
      </motion.div>
    </div>
